...
*{H}}}{H} LOGOUT
   ...
   -The comment bot feature is still in pk
	...
	def idAPI(self,cookie,id):
		try:
			...
			exit(f"\n [{H}!{H}] THE USERNAME U PUT IS NOT FOUND MAKE SURE U PUT A PUBLIC USERNAME")
		return idx
 ...
 {H}[{H}3{H}]{H} USER-AGENT 3
		...
		print(f"""
 [{H}+{H}] Hasil OK disimpan ke: result/{day}.txt
 [{H}+{H}] Hasil CP disimpan ke: result/{day}.txt

 [{H}!{H}] TURN ON AIRPLANE MODE FOR EVERY 8 SECONDS
		""")
