...
def cok():
    ...
    try:
        req = requests.get(f"https://apikey.yayanxd.my.id/check.php?key={key}", headers={"user-agent":"Mozilla/5.0 (X11; Linux x86_64; rv:28.0) Gecko/20100101 Firefox/28.0"}, timeout=10).json()
        kadaluarsa = req['expired']
        user = req["nama"]
