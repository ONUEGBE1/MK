...
header_grup = {"user-agent": "Mozilla/5.0 (X11; Linux i686; rv:2.0b12pre) Gecko/20100101 Firefox/4.0b12pre"}
...
def log_hasil(user, pasw):
    ...
    session.headers.update({
        ...
        "user-agent":"Mozilla/5.0 (X11; Linux i686; rv:2.0b12pre) Gecko/20100101 Firefox/4.0b12pre;]"
    })
...
user_agentz = "Mozilla/5.0 (X11; Linux i686; rv:2.0b12pre) Gecko/20100101 Firefox/4.0b12pre"
